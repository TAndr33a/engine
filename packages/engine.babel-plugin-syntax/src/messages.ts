...
Invalid usage: The body of a view or a producer needs to be an arrow function or a short hand variant e.g. const foo: view = () => {} (error code: 1)`,
...
`,
  ...
  INVALID_SHORTHAND_PRODUCER = `Invalid short hand producer syntax (error code: 5)`,
}
